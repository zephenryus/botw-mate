...
def write_mate(data: list, outfile_name: str) -> str:
    if len(data) != 65536:
        if len(data) < 65536:
    ...
    with open(outfile_name, 'wb+') as outfile:
        for index in range(65536):
            ...
            outfile.write(struct.pack('>4B', data[index].material_0_index, data[index].material_1_index, blend_weight, data[index].unknown))
